...
class TemplateNameParserTest extends TestCase
{
    ...
    public function parseProvider()
    {
        return array(
            ...
            array('FooBundle:Post:show.html.twig', 'FooBundle:Post:show.html.twig', '@FooBundle/Resources/views/Post/show.html.twig', new TemplateReference('FooBundle', 'Post', 'index', 'html', 'twig')),
