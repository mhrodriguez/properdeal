...
class Prospecto
{
     ...
     * @ORM\JoinColumn(name="id_canal_captacion", referencedColumnName="id")
     */
    protected $id_canal_captacion;

    /**
     * @ORM\ManyToOne(targetEntity="EstatusAvance")
     * @ORM\JoinColumn(name="id_estatus_avance", referencedColumnName="id")
     */
    protected $id_estatus_avance;

    /**
     * @ORM\ManyToOne(targetEntity="TipoProspecto")
     * @ORM\JoinColumn(name="id_tipo_prospecto", referencedColumnName="id", nullable=true)
     */
    ...
    /**
     * @ORM\ManyToMany(targetEntity="Solicitud")
     * @ORM\JoinTable(name="prospecto_solicitud",
     *      joinColumns={@ORM\JoinColumn(name="id_prospecto", referencedColumnName="id")},
     *      inverseJoinColumns={@ORM\JoinColumn(name="id_solicitud", referencedColumnName="id")}
     *      )
     */
     ...
     * @return Prospecto
     */
    public function addSolicitud(\AppBundle\Entity\Solicitud $solicitudes)
    {
     ...
     * @param \AppBundle\Entity\Solicitud $solicitudes
     */
    public function removeSolicitud(\AppBundle\Entity\Solicitud $solicitudes)
    {
