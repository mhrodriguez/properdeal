...
class appProdProjectContainer extends Container
{
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_17806a5381f97ec2ac59421deb3355adca3410989bcfe0932a4dbd0a2731ff4b');
        return $instance;
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $r->add($g, array(0 => 'ROLE_AGENTE_INMOBILIARIO'), NULL);
        $r->add($h, array(0 => 'ROLE_AGENTE_INMOBILIARIO'), NULL);
        $r->add($i, array(0 => 'ROLE_AGENTE_INMOBILIARIO'), NULL);
        $r->add($j, array(0 => 'ROLE_AGENTE_INMOBILIARIO'), NULL);
        $r->add($k, array(0 => 'ROLE_AGENTE_INMOBILIARIO'), NULL);
        $r->add($l, array(0 => 'ROLE_AGENTE_INMOBILIARIO'), NULL);
        $r->add($m, array(0 => 'ROLE_AGENTE_INMOBILIARIO'), NULL);
        $r->add($n, array(0 => 'ROLE_AGENTE_INMOBILIARIO'), NULL);
        $r->add($o, array(0 => 'ROLE_AGENTE_INMOBILIARIO'), NULL);
        $r->add($p, array(0 => 'ROLE_AGENTE_INMOBILIARIO'), NULL);
        $r->add($q, array(0 => 'ROLE_AGENTE_INMOBILIARIO'), NULL);
        ...
        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($r, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $this->get('security.user.provider.concrete.pd_db_provider')), 'main', $a, $c), 2 => $t, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $f, new \Symfony\Component\Security\Http\Session\SessionAuthenticationStrategy('migrate'), $s, 'main', $u, $v, array('check_path' => 'login', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true), $a, $c, NULL), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '57428d04851948.35262619', $a, $f), 5 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $r, $f)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $s, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $s, 'login', false), NULL, NULL, $a, false));
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), false, array(), array(0 => 'FrameworkBundle', 1 => 'SecurityBundle', 2 => 'TwigBundle', 3 => 'MonologBundle', 4 => 'SwiftmailerBundle', 5 => 'AsseticBundle', 6 => 'DoctrineBundle', 7 => 'SensioFrameworkExtraBundle', 8 => 'SaadTaziGChartBundle', 9 => 'AppBundle'), new \Symfony\Bundle\AsseticBundle\DefaultValueSupplier($this)));
