...
class Municipio extends \AppBundle\Entity\Municipio implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Municipio' . "\0" . 'idMunicipio', '' . "\0" . 'AppBundle\\Entity\\Municipio' . "\0" . 'nombre', '' . "\0" . 'AppBundle\\Entity\\Municipio' . "\0" . 'estado', '' . "\0" . 'AppBundle\\Entity\\Municipio' . "\0" . 'activo');
        }
