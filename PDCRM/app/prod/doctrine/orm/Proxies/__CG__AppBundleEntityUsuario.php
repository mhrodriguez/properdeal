...
class Usuario extends \AppBundle\Entity\Usuario implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Usuario' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Usuario' . "\0" . 'nombre', '' . "\0" . 'AppBundle\\Entity\\Usuario' . "\0" . 'password', '' . "\0" . 'AppBundle\\Entity\\Usuario' . "\0" . 'email', '' . "\0" . 'AppBundle\\Entity\\Usuario' . "\0" . 'empresa', '' . "\0" . 'AppBundle\\Entity\\Usuario' . "\0" . 'telefono', '' . "\0" . 'AppBundle\\Entity\\Usuario' . "\0" . 'fechaCreacion', '' . "\0" . 'AppBundle\\Entity\\Usuario' . "\0" . 'activo', 'rol', '' . "\0" . 'AppBundle\\Entity\\Usuario' . "\0" . 'colaboradores', '' . "\0" . 'AppBundle\\Entity\\Usuario' . "\0" . 'idUsuarioPadre', 'pathFoto', 'urlFoto', 'fileFoto', 'pathLogo', 'urlLogo', 'fileLogo');
        }
