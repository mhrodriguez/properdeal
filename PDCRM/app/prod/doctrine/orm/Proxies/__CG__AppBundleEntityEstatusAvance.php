 ...
 */
class EstatusAvance extends \AppBundle\Entity\EstatusAvance implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\EstatusAvance' . "\0" . 'idEstatusAvance', '' . "\0" . 'AppBundle\\Entity\\EstatusAvance' . "\0" . 'nombre', '' . "\0" . 'AppBundle\\Entity\\EstatusAvance' . "\0" . 'descripcion', '' . "\0" . 'AppBundle\\Entity\\EstatusAvance' . "\0" . 'porcentaje', '' . "\0" . 'AppBundle\\Entity\\EstatusAvance' . "\0" . 'activo');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EstatusAvance $proxy) {
    ...
    public function getIdEstatusAvance()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getIdEstatusAvance();
        }
