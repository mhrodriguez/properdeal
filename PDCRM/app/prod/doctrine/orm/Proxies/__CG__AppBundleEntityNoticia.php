...
class Noticia extends \AppBundle\Entity\Noticia implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Noticia' . "\0" . 'idNoticia', '' . "\0" . 'AppBundle\\Entity\\Noticia' . "\0" . 'titulo', '' . "\0" . 'AppBundle\\Entity\\Noticia' . "\0" . 'descripcion', '' . "\0" . 'AppBundle\\Entity\\Noticia' . "\0" . 'url', '' . "\0" . 'AppBundle\\Entity\\Noticia' . "\0" . 'publicar', '' . "\0" . 'AppBundle\\Entity\\Noticia' . "\0" . 'fechaCreacion', '' . "\0" . 'AppBundle\\Entity\\Noticia' . "\0" . 'activo');
        }
