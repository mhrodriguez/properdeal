 ...
 */
class ListaContacto extends \AppBundle\Entity\ListaContacto implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\ListaContacto' . "\0" . 'idListaContacto', '' . "\0" . 'AppBundle\\Entity\\ListaContacto' . "\0" . 'nombre', 'id_usuario', '' . "\0" . 'AppBundle\\Entity\\ListaContacto' . "\0" . 'activo');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ListaContacto $proxy) {
    ...
    public function getIdListaContacto()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getIdListaContacto();
        }
