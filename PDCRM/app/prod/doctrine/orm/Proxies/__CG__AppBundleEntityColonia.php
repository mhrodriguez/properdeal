...
class Colonia extends \AppBundle\Entity\Colonia implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Colonia' . "\0" . 'idColonia', '' . "\0" . 'AppBundle\\Entity\\Colonia' . "\0" . 'nombre', '' . "\0" . 'AppBundle\\Entity\\Colonia' . "\0" . 'municipio', '' . "\0" . 'AppBundle\\Entity\\Colonia' . "\0" . 'activo');
        }
    ...
    public function getIdColonia()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getIdColonia();
        }
