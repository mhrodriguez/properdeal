...
class __TwigTemplate_c4b1dfde194a57c5a01df8ec6c5b6500a1b99060a035161b7fb46120985878a2 extends Twig_Template
{
    ...
    public function block_body($context, array $blocks = array())
    {
        ...
        echo "?filtro=1\" style=\"width:100%; height:100%;\" frameBorder=\"0\"></iframe>
                </div>
                <div id=\"tabMiOficina\" class=\"col s12\" style=\"height: 70vh\">
                    <iframe src=\"";
        // line 35
        echo $this->env->getExtension('routing')->getPath("solicitud_resultadosfiltro", array());
        echo "?filtro=2\"  style=\"width:100%; height:100%;\" frameBorder=\"0\"></iframe>
                </div>
                <div id=\"tabRed\" class=\"col s12\" style=\"height: 70vh\">
                    <iframe src=\"";
        // line 38
        echo $this->env->getExtension('routing')->getPath("solicitud_resultadosfiltro", array());
        echo "?filtro=3\" style=\"width:100%; height:100%;\" frameBorder=\"0\"></iframe>
                </div>
                <div id=\"tabBuscar\" class=\"col s12\" style=\"height: 75vh\">
                    <iframe src=\"";
        // line 41
        echo $this->env->getExtension('routing')->getPath("solicitud_buscarform", array());
        echo "\" style=\"width:100%; height:100%;\" frameBorder=\"0\"></iframe>
                </div>
            </div>
        </div>
...
/*                 </div>*/
/*                 <div id="tabMisSolicitudes" class="col s12" style="height: 70vh">*/
/*                     <iframe src="{{ path('solicitud_resultadosfiltro', {}) }}?filtro=1" style="width:100%; height:100%;" frameBorder="0"></iframe>*/
/*                 </div>*/
/*                 <div id="tabMiOficina" class="col s12" style="height: 70vh">*/
/*                     <iframe src="{{ path('solicitud_resultadosfiltro', {}) }}?filtro=2"  style="width:100%; height:100%;" frameBorder="0"></iframe>*/
/*                 </div>*/
/*                 <div id="tabRed" class="col s12" style="height: 70vh">*/
/*                     <iframe src="{{ path('solicitud_resultadosfiltro', {}) }}?filtro=3" style="width:100%; height:100%;" frameBorder="0"></iframe>*/
/*                 </div>*/
/*                 <div id="tabBuscar" class="col s12" style="height: 75vh">*/
/*                     <iframe src="{{ path('solicitud_buscarform', {}) }}" style="width:100%; height:100%;" frameBorder="0"></iframe>*/
/*                 </div>*/
/*             </div>*/
/*         </div>*/
/* */
