...
class __TwigTemplate_5256d652fd55bbd35993e68b08fb90e11e8af79a5bc20a05f8edcb38b17b2441 extends Twig_Template
{
    ...
    <div class=\"row\">
        <div class=\"formcontainer\">
            <div>
                ";
        // line 21
        echo         $this->env->getExtension('form')->renderer->renderBlock((isset($context["form"]) ? $context["form"] : null), 'form_start', array("action" => (($this->env->getExtension('routing')->getPath("inmuebleimagen_new") . "?idInmueble=") . (isset($context["idInmueble"]) ? $context["idInmueble"] : null))));
        echo "
...
/*         <div class="formcontainer">*/
/*             <div>*/
/*                 {{ form_start(form, {'action': path('inmuebleimagen_new')~'?idInmueble='~idInmueble }) }}*/
/* */
/*                 <div class="row">*/
/*                     <div class="input-field col s12">*/
...
/* */
/*                 <input type="submit" value="Guardar" class="waves-effect waves-light btn blue darken-4 right"/>*/
/*                 <a href="{{ path('inmuebleimagen_index', {}) }}?idInmueble={{ idInmueble }}" class="waves-effect waves-light btn blue darken-4 right">Cancelar<a/>*/
/* */
/*                 {{ form_end(form) }}*/
/*             </div>*/
/*         </div>*/
