...
class appProdProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'security.user.provider.concrete.pd_db_provider' => 'getSecurity_User_Provider_Concrete_PdDbProviderService',
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'SaadTaziGChartBundle', ($this->targetDirs[2].'/Resources/SaadTaziGChartBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'SaadTaziGChartBundle', ($this->targetDirs[3].'/vendor/saad-tazi/g-chart-bundle/SaadTazi/GChartBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'LiuggioExcelBundle', ($this->targetDirs[2].'/Resources/LiuggioExcelBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'LiuggioExcelBundle', ($this->targetDirs[3].'/vendor/liuggio/ExcelBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
    ...
    {
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => 3306, 'dbname' => 'PD', 'user' => 'pdapp', 'password' => 'pdapp780721', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), new \Doctrine\DBAL\Configuration(), new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_38ece07cb60886bd35504871a4999260eb3b7bae803325dba0919740c6a99f55');
        return $instance;
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $g = new \Symfony\Component\HttpFoundation\RequestMatcher('/panel_principal');
        $h = new \Symfony\Component\HttpFoundation\RequestMatcher('/usuario/new');
        $i = new \Symfony\Component\HttpFoundation\RequestMatcher('/asesor');
        $j = new \Symfony\Component\HttpFoundation\RequestMatcher('/panel_prospecto');
        $k = new \Symfony\Component\HttpFoundation\RequestMatcher('/prospecto');
        $l = new \Symfony\Component\HttpFoundation\RequestMatcher('/panel_inmueble');
        $m = new \Symfony\Component\HttpFoundation\RequestMatcher('/inmueble');
        $n = new \Symfony\Component\HttpFoundation\RequestMatcher('/contacto');
        $o = new \Symfony\Component\HttpFoundation\RequestMatcher('/listacontacto');
        $p = new \Symfony\Component\HttpFoundation\RequestMatcher('/colaborador');
        $q = new \Symfony\Component\HttpFoundation\RequestMatcher('/inmuebleimagen');
        $r = new \Symfony\Component\HttpFoundation\RequestMatcher('/consultarinmueble');
        $s = new \Symfony\Component\HttpFoundation\RequestMatcher('/panel_blog');
        $t = new \Symfony\Component\HttpFoundation\RequestMatcher('/noticia');
        $u = new \Symfony\Component\HttpFoundation\RequestMatcher('/panel_resumen');
        $v = new \Symfony\Component\HttpFoundation\RequestMatcher('/resumen');
        $w = new \Symfony\Component\HttpFoundation\RequestMatcher('/panel_mensaje');
        $x = new \Symfony\Component\HttpFoundation\RequestMatcher('/mensaje');
        $y = new \Symfony\Component\HttpFoundation\RequestMatcher('/panel_miperfil');
        $z = new \Symfony\Component\HttpFoundation\RequestMatcher('/ids');
        $aa = new \Symfony\Component\Security\Http\AccessMap();
        $aa->add($g, array(0 => 'ROLE_AGENTE_INMOBILIARIO', 1 => 'ROLE_ASESOR', 2 => 'ROLE_SUPERADMIN'), NULL);
        $aa->add($h, array(0 => 'ROLE_SUPERADMIN'), NULL);
        $aa->add($i, array(0 => 'ROLE_AGENTE_INMOBILIARIO', 1 => 'ROLE_SUPERADMIN'), NULL);
        $aa->add($j, array(0 => 'ROLE_AGENTE_INMOBILIARIO', 1 => 'ROLE_ASESOR', 2 => 'ROLE_SUPERADMIN'), NULL);
        $aa->add($k, array(0 => 'ROLE_AGENTE_INMOBILIARIO', 1 => 'ROLE_ASESOR', 2 => 'ROLE_SUPERADMIN'), NULL);
        $aa->add($l, array(0 => 'ROLE_AGENTE_INMOBILIARIO', 1 => 'ROLE_ASESOR', 2 => 'ROLE_SUPERADMIN'), NULL);
        $aa->add($m, array(0 => 'ROLE_AGENTE_INMOBILIARIO', 1 => 'ROLE_ASESOR', 2 => 'ROLE_SUPERADMIN'), NULL);
        $aa->add($n, array(0 => 'ROLE_AGENTE_INMOBILIARIO', 1 => 'ROLE_ASESOR', 2 => 'ROLE_SUPERADMIN'), NULL);
        $aa->add($o, array(0 => 'ROLE_AGENTE_INMOBILIARIO', 1 => 'ROLE_ASESOR', 2 => 'ROLE_SUPERADMIN'), NULL);
        $aa->add($p, array(0 => 'ROLE_AGENTE_INMOBILIARIO', 1 => 'ROLE_ASESOR', 2 => 'ROLE_SUPERADMIN'), NULL);
        $aa->add($q, array(0 => 'ROLE_AGENTE_INMOBILIARIO', 1 => 'ROLE_ASESOR', 2 => 'ROLE_SUPERADMIN'), NULL);
        $aa->add($r, array(0 => 'ROLE_AGENTE_INMOBILIARIO', 1 => 'ROLE_ASESOR', 2 => 'ROLE_SUPERADMIN'), NULL);
        $aa->add($s, array(0 => 'ROLE_AGENTE_INMOBILIARIO', 1 => 'ROLE_ASESOR', 2 => 'ROLE_SUPERADMIN'), NULL);
        $aa->add($t, array(0 => 'ROLE_AGENTE_INMOBILIARIO', 1 => 'ROLE_ASESOR', 2 => 'ROLE_SUPERADMIN'), NULL);
        $aa->add($u, array(0 => 'ROLE_AGENTE_INMOBILIARIO', 1 => 'ROLE_ASESOR', 2 => 'ROLE_SUPERADMIN'), NULL);
        $aa->add($v, array(0 => 'ROLE_AGENTE_INMOBILIARIO', 1 => 'ROLE_ASESOR', 2 => 'ROLE_SUPERADMIN'), NULL);
        $aa->add($w, array(0 => 'ROLE_AGENTE_INMOBILIARIO', 1 => 'ROLE_ASESOR', 2 => 'ROLE_SUPERADMIN'), NULL);
        $aa->add($x, array(0 => 'ROLE_AGENTE_INMOBILIARIO', 1 => 'ROLE_ASESOR', 2 => 'ROLE_SUPERADMIN'), NULL);
        $aa->add($y, array(0 => 'ROLE_AGENTE_INMOBILIARIO', 1 => 'ROLE_ASESOR', 2 => 'ROLE_SUPERADMIN'), NULL);
        $aa->add($z, array(0 => 'ROLE_AGENTE_INMOBILIARIO', 1 => 'ROLE_ASESOR', 2 => 'ROLE_SUPERADMIN'), NULL);
        $ba = new \Symfony\Component\Security\Http\HttpUtils($d, $d);
        $ca = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $ba, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($ba, '/'), array('csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'logout', 'logout_path' => '/logout'));
        $ca->addHandler(new \Symfony\Component\Security\Http\Logout\SessionLogoutHandler());
        $da = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationSuccessHandler($ba, array());
        $da->setOptions(array('login_path' => 'login', 'always_use_default_target_path' => false, 'default_target_path' => '/', 'target_path_parameter' => '_target_path', 'use_referer' => false));
        $da->setProviderKey('main');
        $ea = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationFailureHandler($e, $ba, array(), $a);
        $ea->setOptions(array('login_path' => 'login', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'));
        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($aa, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $this->get('security.user.provider.concrete.pd_db_provider')), 'main', $a, $c), 2 => $ca, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $f, new \Symfony\Component\Security\Http\Session\SessionAuthenticationStrategy('migrate'), $ba, 'main', $da, $ea, array('check_path' => 'login', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true), $a, $c, NULL), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '58afc5ad396e84.68930109', $a, $f), 5 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $aa, $f)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $ba, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $ba, 'login', false), NULL, NULL, $a, false));
    }
    ...
    {
        return $this->services['session.storage.native'] = new \Symfony\Component\HttpFoundation\Session\Storage\NativeSessionStorage(array('cookie_lifetime' => 172800, 'cookie_httponly' => true, 'gc_maxlifetime' => 172800, 'gc_probability' => 1), NULL, $this->get('session.storage.metadata_bag'));
    }
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $instance->setHost('mail.properdeal.mx');
        $instance->setPort(25);
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), false, array(), array(0 => 'FrameworkBundle', 1 => 'SecurityBundle', 2 => 'TwigBundle', 3 => 'MonologBundle', 4 => 'SwiftmailerBundle', 5 => 'AsseticBundle', 6 => 'DoctrineBundle', 7 => 'SensioFrameworkExtraBundle', 8 => 'SaadTaziGChartBundle', 9 => 'LiuggioExcelBundle', 10 => 'AppBundle'), new \Symfony\Bundle\AsseticBundle\DefaultValueSupplier($this)));
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('2437e27d78e37b9a8ac070438479324d25fc4ec7');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($this->get('security.user.provider.concrete.pd_db_provider'), $this->get('security.user_checker.main'), 'main', $this->get('security.encoder_factory'), true), 1 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('58afc5ad396e84.68930109')), true);
    ...
    protected function getSecurity_User_Provider_Concrete_PdDbProviderService()
    {
        return $this->services['security.user.provider.concrete.pd_db_provider'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider($this->get('doctrine'), 'AppBundle:Usuario', 'email', NULL);
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'database_name' => 'PD',
            'database_user' => 'pdapp',
            'database_password' => 'pdapp780721',
            'mailer_transport' => 'smtp',
            'mailer_host' => 'mail.properdeal.mx',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'secret' => '2437e27d78e37b9a8ac070438479324d25fc4ec7',
            'domain_root_name' => 'http://104.236.50.14/',
            'locale' => 'es',
            ...
            'kernel.secret' => '2437e27d78e37b9a8ac070438479324d25fc4ec7',
            ...
            'swiftmailer.mailer.default.transport.smtp.host' => 'mail.properdeal.mx',
            ...
            'assetic.bundles' => array(
                ...
                8 => 'SaadTaziGChartBundle',
                9 => 'LiuggioExcelBundle',
                10 => 'AppBundle',
            ),
