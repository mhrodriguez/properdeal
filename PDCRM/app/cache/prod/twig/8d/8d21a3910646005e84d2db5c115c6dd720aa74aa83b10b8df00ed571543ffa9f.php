...
class __TwigTemplate_faf9b1f4a004147fedd94968931cd4c1ea93c3f131cdb89431fb52db8fc4c809 extends Twig_Template
{
    ...
    <div class=\"container\">
        ...
        echo "
                    ...
                    <input type=\"hidden\" id=\"txtSegundoPaso\" name=\"txtSegundoPaso\" value=\"false\"/>

                    <input type=\"submit\" value=\"Siguiente Paso\" class=\"btn blue darken-4 right\"
                    onclick=\"document.getElementById('txtSegundoPaso').value=true; return true;\"/>
                    <input type=\"submit\" value=\"Guardar\" class=\"btn blue darken-4 right\" style=\"margin-right: 10px\"/>
        ...
        echo "\" class=\"btn blue darken-4 left\">Cancelar</a>
...
/* */
/*                     {{ form_end(form) }}*/
/*                     <a href="{{ path('prospecto_index', {}) }}" class="btn blue darken-4 left">Cancelar</a>*/
/* */
/*                 </div>*/
/*         </div>*/
/*     </div>*/
