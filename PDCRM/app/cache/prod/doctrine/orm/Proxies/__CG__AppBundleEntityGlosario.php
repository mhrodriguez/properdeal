 ...
 */
class Glosario extends \AppBundle\Entity\Glosario implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Glosario' . "\0" . 'idGlosario', '' . "\0" . 'AppBundle\\Entity\\Glosario' . "\0" . 'nombre', '' . "\0" . 'AppBundle\\Entity\\Glosario' . "\0" . 'descripcion', '' . "\0" . 'AppBundle\\Entity\\Glosario' . "\0" . 'activo');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Glosario $proxy) {
    ...
    public function getIdGlosario()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getIdGlosario();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIdGlosario', array());

        return parent::getIdGlosario();
    }
    ...
    public function setIdGlosario($idGlosario)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setIdGlosario', array($idGlosario));

        return parent::setIdGlosario($idGlosario);
    }
