 ...
 */
class RotuloElemento extends \AppBundle\Entity\RotuloElemento implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\RotuloElemento' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\RotuloElemento' . "\0" . 'nombre', '' . "\0" . 'AppBundle\\Entity\\RotuloElemento' . "\0" . 'activo');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (RotuloElemento $proxy) {
