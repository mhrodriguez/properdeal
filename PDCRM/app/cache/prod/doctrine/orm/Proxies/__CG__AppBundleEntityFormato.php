...
class Formato extends \AppBundle\Entity\Formato implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Formato' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Formato' . "\0" . 'usuario', '' . "\0" . 'AppBundle\\Entity\\Formato' . "\0" . 'titulo', '' . "\0" . 'AppBundle\\Entity\\Formato' . "\0" . 'texto', '' . "\0" . 'AppBundle\\Entity\\Formato' . "\0" . 'activo');
        }
