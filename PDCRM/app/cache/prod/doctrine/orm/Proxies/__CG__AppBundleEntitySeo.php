 ...
 */
class Seo extends \AppBundle\Entity\Seo implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Seo' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Seo' . "\0" . 'titulo', '' . "\0" . 'AppBundle\\Entity\\Seo' . "\0" . 'keywords', '' . "\0" . 'AppBundle\\Entity\\Seo' . "\0" . 'descripcion', '' . "\0" . 'AppBundle\\Entity\\Seo' . "\0" . 'mision', '' . "\0" . 'AppBundle\\Entity\\Seo' . "\0" . 'telefono', '' . "\0" . 'AppBundle\\Entity\\Seo' . "\0" . 'fax', '' . "\0" . 'AppBundle\\Entity\\Seo' . "\0" . 'direccion', '' . "\0" . 'AppBundle\\Entity\\Seo' . "\0" . 'derechosautor', '' . "\0" . 'AppBundle\\Entity\\Seo' . "\0" . 'usuario', '' . "\0" . 'AppBundle\\Entity\\Seo' . "\0" . 'activo');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Seo $proxy) {
    ...
    public function setDerechosautor($derechosautor)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setDerechosautor', array($derechosautor));

        return parent::setDerechosautor($derechosautor);
    }
    ...
    public function getDerechosautor()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getDerechosautor', array());

        return parent::getDerechosautor();
    }
