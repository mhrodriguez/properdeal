 ...
 */
class RotuloTamano extends \AppBundle\Entity\RotuloTamano implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\RotuloTamano' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\RotuloTamano' . "\0" . 'nombre', '' . "\0" . 'AppBundle\\Entity\\RotuloTamano' . "\0" . 'activo');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (RotuloTamano $proxy) {
