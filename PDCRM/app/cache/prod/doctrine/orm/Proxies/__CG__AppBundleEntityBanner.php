 ...
 */
class Banner extends \AppBundle\Entity\Banner implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Banner' . "\0" . 'domainRootName', 'idBanner', 'url', 'nombre', 'activo', '' . "\0" . 'AppBundle\\Entity\\Banner' . "\0" . 'file');
        }
