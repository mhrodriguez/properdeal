 ...
 */
class RotuloAccion extends \AppBundle\Entity\RotuloAccion implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\RotuloAccion' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\RotuloAccion' . "\0" . 'nombre', '' . "\0" . 'AppBundle\\Entity\\RotuloAccion' . "\0" . 'activo');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (RotuloAccion $proxy) {
