 ...
 */
class Destacado extends \AppBundle\Entity\Destacado implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Destacado' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Destacado' . "\0" . 'inmueble', '' . "\0" . 'AppBundle\\Entity\\Destacado' . "\0" . 'nombre', '' . "\0" . 'AppBundle\\Entity\\Destacado' . "\0" . 'descripcion', '' . "\0" . 'AppBundle\\Entity\\Destacado' . "\0" . 'activo');
        }
