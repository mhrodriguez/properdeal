...
class appDevProjectContainer extends Container
{
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $h = new \Symfony\Component\HttpFoundation\RequestMatcher('/asesor');
        $i = new \Symfony\Component\HttpFoundation\RequestMatcher('/panel_prospecto');
        $j = new \Symfony\Component\HttpFoundation\RequestMatcher('/prospecto');
        $k = new \Symfony\Component\HttpFoundation\RequestMatcher('/panel_inmueble');
        $l = new \Symfony\Component\HttpFoundation\RequestMatcher('/inmueble');
        $m = new \Symfony\Component\HttpFoundation\RequestMatcher('/contacto');
        $n = new \Symfony\Component\HttpFoundation\RequestMatcher('/listacontacto');
        $o = new \Symfony\Component\HttpFoundation\RequestMatcher('/colaborador');
        $p = new \Symfony\Component\HttpFoundation\RequestMatcher('/inmuebleimagen');
        $q = new \Symfony\Component\HttpFoundation\RequestMatcher('/consultarinmueble');
        $r = new \Symfony\Component\HttpFoundation\RequestMatcher('/panel_blog');
        $s = new \Symfony\Component\HttpFoundation\RequestMatcher('/noticia');
        $t = new \Symfony\Component\HttpFoundation\RequestMatcher('/panel_resumen');
        $u = new \Symfony\Component\HttpFoundation\RequestMatcher('/resumen');
        $v = new \Symfony\Component\HttpFoundation\RequestMatcher('/panel_mensaje');
        $w = new \Symfony\Component\HttpFoundation\RequestMatcher('/mensaje');
        $x = new \Symfony\Component\HttpFoundation\RequestMatcher('/panel_miperfil');
        $y = new \Symfony\Component\Security\Http\AccessMap();
        $y->add($g, array(0 => 'ROLE_AGENTE_INMOBILIARIO', 1 => 'ROLE_ASESOR'), NULL);
        $y->add($h, array(0 => 'ROLE_AGENTE_INMOBILIARIO'), NULL);
        $y->add($i, array(0 => 'ROLE_AGENTE_INMOBILIARIO', 1 => 'ROLE_ASESOR'), NULL);
        $y->add($j, array(0 => 'ROLE_AGENTE_INMOBILIARIO', 1 => 'ROLE_ASESOR'), NULL);
        $y->add($k, array(0 => 'ROLE_AGENTE_INMOBILIARIO', 1 => 'ROLE_ASESOR'), NULL);
        $y->add($l, array(0 => 'ROLE_AGENTE_INMOBILIARIO', 1 => 'ROLE_ASESOR'), NULL);
        $y->add($m, array(0 => 'ROLE_AGENTE_INMOBILIARIO', 1 => 'ROLE_ASESOR'), NULL);
        $y->add($n, array(0 => 'ROLE_AGENTE_INMOBILIARIO', 1 => 'ROLE_ASESOR'), NULL);
        $y->add($o, array(0 => 'ROLE_AGENTE_INMOBILIARIO', 1 => 'ROLE_ASESOR'), NULL);
        $y->add($p, array(0 => 'ROLE_AGENTE_INMOBILIARIO', 1 => 'ROLE_ASESOR'), NULL);
        $y->add($q, array(0 => 'ROLE_AGENTE_INMOBILIARIO', 1 => 'ROLE_ASESOR'), NULL);
        $y->add($r, array(0 => 'ROLE_AGENTE_INMOBILIARIO', 1 => 'ROLE_ASESOR'), NULL);
        $y->add($s, array(0 => 'ROLE_AGENTE_INMOBILIARIO', 1 => 'ROLE_ASESOR'), NULL);
        $y->add($t, array(0 => 'ROLE_AGENTE_INMOBILIARIO', 1 => 'ROLE_ASESOR'), NULL);
        $y->add($u, array(0 => 'ROLE_AGENTE_INMOBILIARIO', 1 => 'ROLE_ASESOR'), NULL);
        $y->add($v, array(0 => 'ROLE_AGENTE_INMOBILIARIO', 1 => 'ROLE_ASESOR'), NULL);
        $y->add($w, array(0 => 'ROLE_AGENTE_INMOBILIARIO', 1 => 'ROLE_ASESOR'), NULL);
        $y->add($x, array(0 => 'ROLE_AGENTE_INMOBILIARIO', 1 => 'ROLE_ASESOR'), NULL);
        ...
        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($y, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $this->get('security.user.provider.concrete.pd_db_provider')), 'main', $a, $c), 2 => $aa, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $f, new \Symfony\Component\Security\Http\Session\SessionAuthenticationStrategy('migrate'), $z, 'main', $ba, $ca, array('check_path' => 'login', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true), $a, $c, NULL), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '57b4fd42247860.21203332', $a, $f), 5 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $y, $f)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $z, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $z, 'login', false), NULL, NULL, $a, false));
    }
