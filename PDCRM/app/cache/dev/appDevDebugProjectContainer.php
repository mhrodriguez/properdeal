...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => 3306, 'dbname' => 'PD', 'user' => 'pdapp', 'password' => 'pdapp780721', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_cab58033a5fc9183f8fc2399f8512511b4f1b27714cbe3a67cf577e40bca17ce');
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $z->add($g, array(0 => 'ROLE_AGENTE_INMOBILIARIO', 1 => 'ROLE_ASESOR', 2 => 'ROLE_SUPERADMIN'), NULL);
        $z->add($h, array(0 => 'ROLE_SUPERADMIN'), NULL);
        $z->add($i, array(0 => 'ROLE_AGENTE_INMOBILIARIO', 1 => 'ROLE_SUPERADMIN'), NULL);
        $z->add($j, array(0 => 'ROLE_AGENTE_INMOBILIARIO', 1 => 'ROLE_ASESOR', 2 => 'ROLE_SUPERADMIN'), NULL);
        $z->add($k, array(0 => 'ROLE_AGENTE_INMOBILIARIO', 1 => 'ROLE_ASESOR', 2 => 'ROLE_SUPERADMIN'), NULL);
        $z->add($l, array(0 => 'ROLE_AGENTE_INMOBILIARIO', 1 => 'ROLE_ASESOR', 2 => 'ROLE_SUPERADMIN'), NULL);
        $z->add($m, array(0 => 'ROLE_AGENTE_INMOBILIARIO', 1 => 'ROLE_ASESOR', 2 => 'ROLE_SUPERADMIN'), NULL);
        $z->add($n, array(0 => 'ROLE_AGENTE_INMOBILIARIO', 1 => 'ROLE_ASESOR', 2 => 'ROLE_SUPERADMIN'), NULL);
        $z->add($o, array(0 => 'ROLE_AGENTE_INMOBILIARIO', 1 => 'ROLE_ASESOR', 2 => 'ROLE_SUPERADMIN'), NULL);
        $z->add($p, array(0 => 'ROLE_AGENTE_INMOBILIARIO', 1 => 'ROLE_ASESOR', 2 => 'ROLE_SUPERADMIN'), NULL);
        $z->add($q, array(0 => 'ROLE_AGENTE_INMOBILIARIO', 1 => 'ROLE_ASESOR', 2 => 'ROLE_SUPERADMIN'), NULL);
        $z->add($r, array(0 => 'ROLE_AGENTE_INMOBILIARIO', 1 => 'ROLE_ASESOR', 2 => 'ROLE_SUPERADMIN'), NULL);
        $z->add($s, array(0 => 'ROLE_AGENTE_INMOBILIARIO', 1 => 'ROLE_ASESOR', 2 => 'ROLE_SUPERADMIN'), NULL);
        $z->add($t, array(0 => 'ROLE_AGENTE_INMOBILIARIO', 1 => 'ROLE_ASESOR', 2 => 'ROLE_SUPERADMIN'), NULL);
        $z->add($u, array(0 => 'ROLE_AGENTE_INMOBILIARIO', 1 => 'ROLE_ASESOR', 2 => 'ROLE_SUPERADMIN'), NULL);
        $z->add($v, array(0 => 'ROLE_AGENTE_INMOBILIARIO', 1 => 'ROLE_ASESOR', 2 => 'ROLE_SUPERADMIN'), NULL);
        $z->add($w, array(0 => 'ROLE_AGENTE_INMOBILIARIO', 1 => 'ROLE_ASESOR', 2 => 'ROLE_SUPERADMIN'), NULL);
        $z->add($x, array(0 => 'ROLE_AGENTE_INMOBILIARIO', 1 => 'ROLE_ASESOR', 2 => 'ROLE_SUPERADMIN'), NULL);
        $z->add($y, array(0 => 'ROLE_AGENTE_INMOBILIARIO', 1 => 'ROLE_ASESOR', 2 => 'ROLE_SUPERADMIN'), NULL);

        $aa = new \Symfony\Component\Security\Http\HttpUtils($d, $d);

        $ba = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $aa, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($aa, '/'), array('csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'logout', 'logout_path' => '/logout'));
        ...
        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($z, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $this->get('security.user.provider.concrete.pd_db_provider')), 'main', $a, $c), 2 => $ba, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $f, new \Symfony\Component\Security\Http\Session\SessionAuthenticationStrategy('migrate'), $aa, 'main', $ca, $da, array('check_path' => 'login', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true), $a, $c, NULL), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '58a45a512cb1c9.52149977', $a, $f), 5 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $z, $f)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $aa, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $aa, 'login', false), NULL, NULL, $a, false));
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), true, array(), array(0 => 'FrameworkBundle', 1 => 'SecurityBundle', 2 => 'TwigBundle', 3 => 'MonologBundle', 4 => 'SwiftmailerBundle', 5 => 'AsseticBundle', 6 => 'DoctrineBundle', 7 => 'SensioFrameworkExtraBundle', 8 => 'SaadTaziGChartBundle', 9 => 'LiuggioExcelBundle', 10 => 'AppBundle', 11 => 'DebugBundle', 12 => 'WebProfilerBundle', 13 => 'SensioDistributionBundle', 14 => 'SensioGeneratorBundle'), new \Symfony\Bundle\AsseticBundle\DefaultValueSupplier($this)));
    ...
    /**
     * Gets the 'security.user.provider.concrete.pd_db_provider' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
