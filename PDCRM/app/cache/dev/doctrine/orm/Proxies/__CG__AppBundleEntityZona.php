 ...
 */
class Zona extends \AppBundle\Entity\Zona implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Zona' . "\0" . 'idZona', '' . "\0" . 'AppBundle\\Entity\\Zona' . "\0" . 'nombre', '' . "\0" . 'AppBundle\\Entity\\Zona' . "\0" . 'activo');
        }
    ...
    public function setIdZona($idZona_)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setIdZona', array($idZona_));

        return parent::setIdZona($idZona_);
    }
